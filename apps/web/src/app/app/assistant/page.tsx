          ...
          <div className="w-full">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h1 className="text-3xl font-semibold tracking-normal text-zinc-950">
                {hasQuery ? "Working on your accounting workspace" : `Hi, ${data.project?.name ?? data.ctx.workspaceName}`}
              </h1>
              {data.project ? (
              ...
              <div className="mx-auto mt-8 max-w-3xl space-y-5">
                ...
                <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
                  ...
                  <div className="mt-4 space-y-4 border-l border-zinc-200 pl-4">
                    ...
                    <Step done label="Applied supervised accounting rules" detail={selectedWorkflow ? selectedWorkflow.title : "GST, invoices, income-tax planning"} />
